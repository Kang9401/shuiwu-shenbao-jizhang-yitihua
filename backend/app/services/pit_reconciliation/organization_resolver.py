...
class PitOrganizationResolver:
    ...
    def resolve_by_branch_name(self, value: str | None): return self.get_org(self.name_to_code.get(normalize_organization_name(value)))
    def resolve_by_full_name(self, value: str | None): return self.get_org(self.full_name_to_code.get(normalize_organization_name(value)))
    def resolve_by_taxpayer_id(self, value: str | None): return self.get_org(self.taxpayer_id_to_code.get((value or "").strip()))
    def resolve_by_rpa_name(self, value: str | None): return self.get_org(self.rpa_name_to_code.get(normalize_organization_name(value)))
