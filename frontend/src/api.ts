...
export const pitReconciliationApi = {
  ...
  getSheetData: (periodId: number, stage: PitStage, sheetName: string, page = 1, pageSize = 100) => api.get<PitSheetData>('/pit-reconciliations/sheet-data', { params: { period_id: periodId, stage, sheet_name: sheetName, page, page_size: pageSize }, timeout: 120000 }),
