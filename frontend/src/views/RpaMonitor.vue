<template>
  <main class="monitor-page">
    <header>
      <div><strong>RPA 任务监控</strong><small>{{ status?.current_run.declaration_month || status?.current_run.month || '未启动' }}</small></div>
    ...
    <footer><el-button type="danger" :disabled="!running" @click="stop">停止任务</el-button></footer>
  </main>
</template>
